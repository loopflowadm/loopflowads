        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-6">
            ...
            <div className="p-8 text-left bg-white border border-neutral-200/70 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.03)] flex-1 flex flex-col justify-center">
              ...
              {/* PAINEL MINIMALISTA PREMIUM AMPLIADO (Movido para cima de 'Quem toca sua conta') */}
              <div className="w-full h-[170px] mb-6 flex items-center justify-center relative select-none">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-neutral-500 leading-relaxed font-semibold">
                  Antes de fundar a Loop Flow, nossa equipe de gestores atuais passaram <strong>5 anos</strong> gerindo tráfego pago e estratégia de marketing para diversos negócios, sendo <strong>2 deles dedicados como consultores diretos da Meta</strong> atendendo mais de 300 clientes de diversos nichos. A Loop Flow nasceu justamente da experiência de ver pequenas empresas pagando caro por atendimento genérico de agência grande.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 flex flex-col sm:flex-row items-center gap-6 text-left bg-white border border-neutral-200/70 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.03)]">
              ...
              <div className="relative w-24 h-24 shrink-0 bg-neutral-50 border border-neutral-200/50 rounded-2xl flex items-center justify-center shadow-sm">
                <svg 
                  className="w-14 h-14 text-[#0064e0]"
                  viewBox="0 0 16 16" 
                  fill="currentColor"
                >
            ...
            <div className="p-8 text-left space-y-6 bg-brand-black border border-white/10 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.4)] flex-1 flex flex-col justify-between relative overflow-hidden group">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <h3 className="text-xl font-bold text-white tracking-tight">
                  Você testa com menos risco: condição de entrada
                </h3>
                <p className="text-sm text-neutral-400 leading-relaxed font-semibold">
                  Por sermos uma operação nova, o primeiro trimestre tem investimento promocional. Se o resultado for satisfatório, seguimos juntos no valor padrão a partir do 4º mês. Você não está apostando no escuro — está testando a metodologia pagando menos até ter certeza de que funciona pra você.
                </p>
                <p className="text-[11px] text-neutral-500 leading-relaxed font-medium mt-2 italic">
                  (Importante: isso é uma condição comercial de entrada, não uma promessa de resultado. Deixe claro no formulário/contrato os critérios que definem "satisfatório" para evitar ruído de expectativa lá na frente.)
                </p>
              </div>
