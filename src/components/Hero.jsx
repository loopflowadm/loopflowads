    ...
    <section ref={heroRef} className="relative min-h-[95vh] flex items-center justify-center pt-28 pb-12 overflow-hidden bg-brand-yellow select-none">
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        >
          ...
          <span className="inline-block bg-brand-black text-brand-yellow px-6 sm:px-8 py-2.5 sm:py-3 rounded-2xl sm:rounded-[24px] shadow-[0_14px_32px_rgba(0,0,0,0.35)] border border-white/10 font-black mx-1 transform -rotate-1 translate-y-[4px] align-middle select-none text-[0.98em]">
            loop de crescimento
          </span>
